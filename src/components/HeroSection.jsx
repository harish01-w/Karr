...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* ── Subtle Overlays with deeper gradients on mobile ── */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/45 to-black/75 md:bg-black/40 pointer-events-none" />
      
      {/* ── Overlay Content ── */}
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-6 md:px-8">
        ...
        <motion.h1 
          ...
          className="text-[2.2rem] sm:text-4xl md:text-5xl lg:text-6xl font-black text-white max-w-5xl leading-[1.1] tracking-tight drop-shadow-2xl px-2"
        >
        ...
        <motion.p 
          ...
          className="mt-6 md:mt-8 text-xs sm:text-sm md:text-lg text-white/80 max-w-2xl font-light leading-relaxed drop-shadow-md px-2"
        >
        ...
        <motion.div 
          ...
          className="mt-10 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 w-full max-w-[300px] sm:max-w-none"
        >
